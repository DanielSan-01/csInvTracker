...
export default function InventoryDetailPanel({ item, onEdit, onDelete, onUpdate }: InventoryDetailPanelProps) {
  return (
    <div className="lg:col-span-1">
      <div className="space-y-6 lg:sticky lg:top-8">
        {item ? (
          <ItemCard item={item} variant="detailed" onEdit={onEdit} onDelete={onDelete} onUpdate={onUpdate} />
        ) : (
